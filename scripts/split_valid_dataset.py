...
anno_list = glob.glob('/home/zly/codes/cervix_wsi_cls/data_resource/cls_pn/cut_img/original/**/*.png')
random_valid = random.sample(anno_list, 3000)
total_valid_list = [*valid_list, *random_valid]
...
for clsid,list_data in enumerate([invalid_list,total_valid_list]):
    train_data_num = int(0.7*len(list_data))
